...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
      .col-lg-8
        p.mb-0 El término diseño es muy utilizado a nivel general; por ejemplo, cuando alguien quiere construir una casa, uno de los pasos iniciales es el diseño, o cuando se habla de una propuesta en un proyecto o una empresa, se planea y se diseña antes de ejecutarla.
          br
          br
          ...
          br
          br
          | Te invitamos a ver el siguiente video, el cual presenta algunas reglas básicas que se deben tener en cuenta en el momento de realizar las piezas gráficas.
