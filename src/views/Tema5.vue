...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.parrafo-tema-5.mb-5(data-aos="flip-up")
      ...
      br
      br
      | El video contiene imágenes en movimiento o estáticas y, normalmente, va acompañado de un audio. Por tal motivo, uno de los componentes importantes a construir es un guion, el cual incluye contenido de audio y de imágenes como si fuera una historieta, a lo que se le conoce como storyboard.
      br
      br
      | Es importante tener en cuenta cómo va a ser la comunicación corporal, o no verbal, dentro de la grabación del video y al ser este un factor a planear, se puede incluir en el storyboard.
      br
      br
    ...
    .row.align-items-center.mb-5(data-aos="flip-up")
      .col-lg-10
        p Una de las plataformas que se ha convertido en la herramienta preferida por los creadores de contenido es CapCut - Video Editor que es una aplicación de edición de video, todo en uno, que ayuda a crear videos increíbles. Corte, retroceder y cambiar la velocidad y mucho más, disponible para dispositivos móviles con sistema operativo iOS y Android.
          br
          br
          | Invitamos a ver el siguiente video, donde se presenta una introducción al manejo de la herramienta Capcut.
